                     ...
                     <ul class="nav navbar-nav">
                        ...
                        <li><a data-scroll href="SendRequest.jsp">Send Request</a></li>
                         <li><a data-scroll href="RequestStatus.jsp">Request Status</a></li>
                          <li><a class="active"  data-scroll href="Decryption.jsp">Decrypt</a></li>
...
<form action="RetrieveImage" method="post" >
   <h2>Upload key To Decrypt Here</h2>
    <table>
  
                                 <tr><th>Enter Key</th><td><input type="text" name="key"  placeholder="Key To Decrypt"  required=""></tD></tr>
