               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a  class="active" data-scroll href="SendRequest.jsp">Send Request</a></li>
         ...
         <form action="SendAction.jsp" method="post">
             <table>
                 <tr><th>Select User</tH><td>
                         ...
                         <%try{
            ResultSet r=DatabaseConnection.getExecuteQuery("select * from user where email!='"+email+"'");
            while(r.next()){
              %>
              
              <option value="<%=r.getString("email")%>"><%=r.getString("email")%></option>  
              <%
            }
        }catch(Exception e){
          out.println(e);  
                 ...
                 <tr><th>Write Message</th>
                     <td><textarea cols='35' rows='10' name='message'></textarea></tD></tr>
