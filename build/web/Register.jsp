               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <a href="" class="typewrite" data-period="2000" data-type='[ "Welcome to Patient Monitoring", "We Care Your Health", "We are Expert!" ]'>
                                     ...
                                     <tr><th>Mobile</th><td><input type="number" name="mobile" required=""></tD></tr>
                                         <tr><th>Address</th><td><input type="text" name="address" required=""></tD></tr>
                                             <tr><th>UserName</th><td><input type="text" name="uname" required=""></tD></tr>
                                                 ...
                                                 Have An Account ?<a href='http://localhost:8084/Patient_Monitoring_System/#getintouch'>Login Here</a>
                         </table>
                     </form>
